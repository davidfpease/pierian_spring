...
class CircleProgress extends Component {
  ...
  render() {
    ...
    const offset0 = (1-percents[0])* circumference;
    const offset1 = (1-percents[0]-percents[1])* circumference;
    const offset2 = (1 - percents[0] - percents[1] - percents[2]) * circumference;
    const offset3 = (1 - percents[0] - percents[1] - percents[2] - percents[3]) * circumference;
    const offset4 = (1 - percents[0] - percents[1] - percents[2] - percents[3] - percents[4]) * circumference;
    const offset5 = (1 - percents[0] - percents[1] - percents[2] - percents[3] - percents[4] - percents[5]) * circumference;
